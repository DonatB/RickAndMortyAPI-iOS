...
class RMCharacterDetailView: UIView {
    ...
    private func createPhotoSectionLayout() -> NSCollectionLayoutSection {
        ...
        let group = NSCollectionLayoutGroup.vertical(layoutSize: NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.5), heightDimension: .absolute(150)), subitems: [item])
